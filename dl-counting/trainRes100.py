...
model_name = '11.8-'+'lr-'+str(lr)+ '-scaled'+'-batch-'+str(batch_size)+'-v'+str(val_version)+'-ResFCN100'
...
#hf.train_model(model,X_train[90:],X_val[90:],Y_train[90:],Y_val[90:], nb_epochs=nb_epochs, nb_epoch_per_record=nb_epoch_per_record, input_shape=input_shape[0], batch_size = batch_size)